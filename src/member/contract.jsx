...
import {
    Container, Paper, Typography, Button, IconButton, Table,
    TableBody, TableCell, TableContainer, TableHead, TableRow,
    Chip, Modal, Pagination, Box, TextField, Select, MenuItem,
    FormControl, InputLabel, Checkbox, FormControlLabel,
    Stepper, Step, StepLabel, ThemeProvider, createTheme,
} from "@mui/material"
                ...
                return (
                    <Box sx={{ mt: 2 }}>
                        ...
                        >
                            ...
                            <IconButton
                                onClick={() =>
                                    handleInputChange("noticePeriod")({ target: { value: Math.max(1, formData.noticePeriod - 1) } })
                                }
                                style={{
                        ...
                        <FormControlLabel
                            control={<Checkbox checked={formData.allowRoll} onChange={handleInputChange("allowRoll")} />}
                            label="Allow this contract to roll"
                        />
                    </Box>
                )
                    ...
                    <Box sx={{ mt: 2 }}>
                        <FormControl fullWidth sx={{ mb: 2 }}>
                            ...
                            <Select
                                ...
                                onChange={handleInputChange("recurringPlan")}
                ...
                return (
                    <Box sx={{ mt: 2 }}>
                        <TextField
                            fullWidth
                            label="Contract Team"
                            value={formData.contractTeam}
                            onChange={handleInputChange("contractTeam")}
                            sx={{ mb: 2 }}
                        />
                        <FormControlLabel
                            control={<Checkbox checked={formData.agreement} onChange={handleInputChange("agreement")} />}
                            label="Check for the agreement"
                        />
                    </Box>
                )
