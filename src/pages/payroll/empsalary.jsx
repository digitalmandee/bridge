					...
					<Container fluid className="py-4 px-4 min-vh-100">
						...
						<Card className="border-0 shadow-sm">
							<Card.Body className="p-0">
								<div className="p-4 d-flex justify-content-end">
									<div className="d-flex align-items-center">
										<div className="position-relative me-3" style={{ width: "250px" }}>
											<Form.Control type="text" placeholder="Search for employ" className="pe-5" />
											<Search
												style={{
													position: "absolute",
													right: "10px",
										...
										<Button variant="light" className="border d-flex align-items-center justify-content-center" style={{ width: "38px", height: "38px" }}>
											<FileDownload />
										</Button>
									</div>
								</div>
								...
								<div className="p-4 text-center text-muted">This is a salary sheet for the Apr-2025</div>
							</Card.Body>
						</Card>
					</Container>
				</div>
