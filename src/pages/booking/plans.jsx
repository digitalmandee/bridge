...
const BookingPlans = () => {
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`${import.meta.env.VITE_BASE_API}booking-plans/${currentPlan.id}`);
  ...
  const handleEditSubmit = async () => {
    try {
      const response = await axios.put(`${import.meta.env.VITE_BASE_API}booking-plans/${currentPlan.id}`, editData);
