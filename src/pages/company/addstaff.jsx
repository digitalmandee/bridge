				...
				<div className="content">
					...
					<div style={{ maxWidth: "90%", margin: "0 auto", padding: "20px", borderRadius: "10px", backgroundColor: "#F9FAFB", boxShadow: "0px 0px 10px rgba(0, 0, 0, 0.1)" }}>
						...
						<div style={{ display: "flex", gap: "20px" }}>
							...
							<div
								...
								<div style={{ width: "100%", maxWidth: "400px", margin: "0 auto" }}>
									...
									<div style={{ marginBottom: "10px" }}>
										<span style={{ display: "block", fontWeight: "bold", marginBottom: "5px" }}>Seat No</span>
										<select style={{ width: "100%", padding: "10px", border: "1px solid #D1D5DB", borderRadius: "5px" }}>
											<option>B16</option>
										</select>
									</div>
									<div style={{ marginBottom: "10px" }}>
										<span style={{ display: "block", fontWeight: "bold", marginBottom: "5px" }}>Booking Quantity</span>
										<input
											type={"number"}
									...
									{[
										...
										<div key={index} style={{ marginBottom: "10px" }}>
											<span style={{ display: "block", fontWeight: "bold", marginBottom: "5px" }}>{field.label}</span>
											<input type="text" placeholder={field.placeholder} style={{ width: "100%", margin: "0", padding: "10px", border: "1px solid #D1D5DB", borderRadius: "5px" }} />
										</div>
									))}
								</div>
							</div>
						...
						<div style={{ textAlign: "center", marginTop: "10px", marginBottom: "1rem" }}>
							{/* Save Button */}
							<button style={{ width: "40%", padding: "12px", backgroundColor: "#0D2B4E", color: "white", border: "none", borderRadius: "5px", fontSize: "16px", cursor: "pointer", marginTop: "10px" }} onClick={() => navigate("/company/staff/management")}>
								Save
							</button>
						</div>
					</div>
