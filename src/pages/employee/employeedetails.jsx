...
import { Grid, Typography, Card, IconButton, FormControlLabel, Radio, RadioGroup, Select, Chip, FormControl, CardContent, TableCell, TableHead, Link, TableContainer, Table, TableBody, TableRow, Avatar, Button, Divider, List, ListItem, ListItemText, Paper, TextField, MenuItem } from "@mui/material";
										...
										<>
											...
											<Grid
												...
												<Grid item xs={12} md={6}>
													...
													<TextField fullWidth value={employee.name || "N/A"} margin="normal" disabled variant="outlined" />
												</Grid>
												<Grid item xs={12} md={6}>
													<Typography variant="body2" fontWeight="bold">
														Employee ID
													</Typography>
													<TextField fullWidth value={employee.id || "N/A"} margin="normal" disabled variant="outlined" />
												</Grid>
												<Grid item xs={12} md={6}>
													<Typography variant="body2" fontWeight="bold">
														National ID
													</Typography>
													<TextField fullWidth value={employee.nationalID || "N/A"} margin="normal" disabled variant="outlined" />
												</Grid>
												...
												<Grid item xs={12} md={6}>
													...
													<TextField fullWidth value={employee.bankAccount || "N/A"} margin="normal" disabled variant="outlined" />
												</Grid>
												...
												<Grid item xs={12} md={6}>
													...
													<TextField fullWidth value={employee.email || "N/A"} margin="normal" disabled variant="outlined" />
												</Grid>
												...
												<Grid item xs={12} md={6}>
													...
													<TextField fullWidth value={employee.contact || "N/A"} margin="normal" disabled variant="outlined" />
												</Grid>
												...
												<Grid item xs={12} md={6}>
													...
													<TextField fullWidth value={employee.emergencyContact || "N/A"} margin="normal" disabled variant="outlined" />
												</Grid>
												...
												<Grid item xs={12} md={6}>
													...
													<TextField fullWidth value={employee.address || "N/A"} margin="normal" disabled variant="outlined" />
												</Grid>

												<Grid item xs={12} style={{ display: "flex", justifyContent: "flex-end" }}>
													<Button variant="contained" sx={{ backgroundColor: "#0D2B4E", "&:hover": { backgroundColor: "#0A223D" } }}>
														Save
													</Button>
												</Grid>
											</Grid>
