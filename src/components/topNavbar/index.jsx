				...
				<div className="container-fluid w-100">
					<div className="row d-flex align-items-center w-100">
						...
						<div className="col-sm-3 d-flex align-items-center part2 pl-4">
							<Button className="square mr-3" onClick={() => context.setIsToggleSidebar(!context.isToggleSidebar)}>
						...
						<div className="col-sm-7 d-flex align-items-center justify-content-end part-3">
							<div className="notifi position-relative">
								<Button className="square mr-3" onClick={handleOpennotificationsDr}>
									<FaRegBell />
								</Button>
							...
							<div className="myAccWrapper">
								...
								<Menu anchorEl={anchorEl} id="account-menu" open={openMyAcc} onClose={handleCloseMyAccDr} onClick={handleCloseMyAccDr} transformOrigin={{ horizontal: "right", vertical: "top" }} anchorOrigin={{ horizontal: "right", vertical: "bottom" }}>
