        ...
        <div className='content'>
          ...
          <div style={{ padding: '16px', backgroundColor: '#F8F9FA', width: '95%' }}>
              ...
              <tbody>
                {data.map((row, index) => (
                  <tr key={index} style={{ borderBottom: '1px solid #ccc' }}>
                    ...
                    <td style={{ padding: '12px', color: row.status === 'Active' ? 'green' : 'red' }}>
                      {row.status}
                    </td>
            ...
            <div style={{ marginTop: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <button style={{ marginRight: '8px', backgroundColor: '#F8F9FA', border: 'none', borderRadius: '4px', padding: '8px' }}>
                  Previous
                </button>
                <button style={{ marginRight: '8px', backgroundColor: '#0D2B4E', color: 'white', border: 'none', borderRadius: '4px', padding: '8px' }}>
                  1
                </button>
                <button style={{ marginRight: '8px', backgroundColor: 'white', border: 'none', borderRadius: '4px', padding: '8px' }}>
                  2
                </button>
                <button style={{ marginRight: '8px', backgroundColor: 'white', border: 'none', borderRadius: '4px', padding: '8px' }}>
                  3
                ...
                <button style={{ backgroundColor: '#F8F9FA', border: 'none', borderRadius: '4px', padding: '8px' }}>
                  Next
                </button>
              </div>
            </div>
