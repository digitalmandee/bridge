...
class LeaveApplicationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $leaveApplications = LeaveApplication::where('start_date', '<=', $date)->where('end_date', '>=', $date)->with('employee:id,user_id', 'employee.user:id,name', 'leaveCategory:id,name')->orderByDesc('created_at')->paginate($limit);
    ...
    public function leaveReport(Request $request)
    {
        ...
        $employees = Employee::with(['user:id,name,profile_image'])->paginate($limit);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (LeaveApplication::where('employee_id', $employeeId)
