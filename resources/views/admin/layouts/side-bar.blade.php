<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            @can('branches')
                <li
                    class="nav-item bar-item mb-1 {{ Request::routeIs('admin.branches', 'admin.branches.create', 'admin.branch.edit') ? 'active' : 'non-active' }}">
            ...
            @can('branch-manager')
                <li
                    class="nav-item bar-item mb-1 {{ Request::routeIs('admin.branch.manager', 'admin.branch.manager.create', 'admin.branch.manager.edit') ? 'active' : 'non-active' }}">
            ...
            @can('investor')
                <li
                    class="nav-item bar-item mb-1 {{ Request::routeIs('admin.investor', 'admin.investor.create', 'admin.investor.edit') ? 'active' : 'non-active' }}">
            ...
            @can('inventory-management')
                <li
                    class="nav-item bar-item mb-1 {{ Request::routeIs('admin.inventory.management') ? 'active' : 'non-active' }}">
            ...
            @can('booking-management')
                <li
                    class="nav-item bar-item mb-1 {{ Request::routeIs('admin.booking.calendar', 'admin.booking.create') ? 'active' : 'non-active' }}">
            ...
            @endcan
            <li class="nav-item bar-item mb-1">
                <a href="{{ route('admin.booking') }}" class="nav-link bar-item bar-link">
                    <img class="link-icon" src="{{ asset('icons/booking.svg') }}" alt="Booking Icon">
                    <span class="link-title">Booking Request</span>
                </a>
            </li>
            <li class="nav-item bar-item mb-1">
                <a href="{{ route('admin.seat.allocation') }}" class="nav-link bar-item bar-link">
            ...
            @can('roles')
                <li
                    class="nav-item bar-item mb-1 {{ Request::routeIs('admin.roles', 'admin.roles.create', 'admin.roles.edit') ? 'active' : 'non-active' }}">
            ...
            @can('permissions')
                <li
                    class="nav-item bar-item mb-1 {{ Request::routeIs('admin.permissions', 'admin.permissions.create', 'admin.permissions.edit') ? 'active' : 'non-active' }}">
