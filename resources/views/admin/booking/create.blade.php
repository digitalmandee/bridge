                ...
                <form action="{{ route('booking.storeUserDetails') }}" method="POST" id="bookingForm">
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-4">
                            ...
                            <input type="hidden" name="table_id" id="selectedTableId <input type="hidden" name="chair_ids" id="selectedChairIds">
...
$(document).ready(function() {
    ...
    $('#branchSelect').on('change', function() {
        ...
        const selectedBranchName = $(this).find('option:selected').data('branch-name');
        $('#selectedBranchId').val(selectedBranchId);
        selectedInfo.branch = selectedBranchName;

        // Show floors for the selected branch
        $('#floors').show();
    });
