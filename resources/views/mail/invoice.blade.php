        ...
        <tr>
            <td align="center">
                ...
                <table width="800" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <!-- Invoice Title -->
                    <tr>
                        <td align="center" style="padding: 8px 0; border-bottom: 3px solid #ffcc16;">
                            <h1
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-bottom: 5px; font-size: 14px;">
                                        <span style="font-weight: 700; color: #626262;">Invoice Number:</span>
                                        <span
                                            style="font-weight: 500; color: #333;">&nbsp;#{{ $data['invoice_id'] }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom: 5px; font-size: 14px;">
                                        <span style="font-weight: 700; color: #626262;">Invoice Date:</span>
                                        <span
                                            style="font-weight: 500; color: #333;">&nbsp;{{ \Carbon\Carbon::parse($data['invoice']['created_at'])->format('d F Y') }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom: 5px; font-size: 14px;">
                                        <span style="font-weight: 700; color: #626262;">Due Date:</span>
                                        <span
                                            style="font-weight: 500; color: #333;">&nbsp;{{ \Carbon\Carbon::parse($data['dueDate'])->format('d F Y') }}</span>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    ...
                                    <td width="48%" valign="top"
                                        style="background-color: #ffcc16; padding-bottom: 10px; border: 1px solid #ffcc16;">
                                        <div
                                            style="background-color: #ffcc16; padding: 10px 15px; font-weight: bold; font-size: 18px; color: #000;">
                                            Billed By</div>
                                        <div
                                            style="font-weight: 600; font-size: 16px; padding: 0 15px 5px 15px; color: #000;">
                                            Bridge</div>
                                        <div style="font-size: 15px; color: #000; padding: 0 15px 3px 15px;">82 J1,
                                            Johar Town, Near Al-Fatah, Lahore.</div>
                                        <div style="font-size: 15px; color: #000; padding: 0 15px 3px 15px;">Lahore.
                                        </div>
                                        <div style="font-size: 15px; color: #000; padding: 0 15px 3px 15px;">Pakistan -
                                            54000</div>
                                    </td>
                                    <td width="4%"></td>
                                    <!-- Billed To -->
                                    <td width="48%" valign="top"
                                        ...
                                        <div
                                            style="font-weight: 600; font-size: 16px; padding: 0 15px 5px 15px; color: #000;">
                                            {{ $data['user']['name'] ?? 'N/A' }}</div>
                                        @if (!empty($data['user']['phone_no']))
                                            <div style="font-size: 15px; color: #000; padding: 0 15px 3px 15px;">
                                                {{ $data['user']['phone_no'] }}</div>
                                        @endif
                                        @if (!empty($data['user']['ntn']))
                                            <div style="font-size: 15px; color: #000; padding: 0 15px 3px 15px;">NTN
                                                {{ $data['user']['ntn'] }}</div>
                                        @endif
                        ...
                        <td style="padding: 20px 30px;">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tbody>
                                    ...
                                    <!-- Loop for additional items if any (Assuming $data['invoice']['items'] exists as seen in React) -->
                    ...
                    <!-- Total Summary Box -->
                    <tr>
                        <td style="padding: 10px 30px 20px 30px; text-align: right;">
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="right">
                                        <div
                    ...
                    <!-- Adjust URLs as per your frontend routes -->
                    {{-- <a href="{{ url('branch/invoice/view/' . $data['invoice_id']) }}"
                                style="display: inline-block; background-color: #000; color: #fff; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold; margin-right: 15px;">View
                                Online</a> --}}

                    <!-- If you have a direct download route, use it here. Otherwise, point to view page -->
                    {{-- <a href="{{ url('branch/invoice/download/' . $data['invoice_id']) }}" style="display: inline-block; background-color: #333; color: #fff; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">Download PDF</a> --}}
                    {{-- </td>
                    </tr> --}}
                    ...
                    <tr>
                        <td align="center"
                            ...
                            For any enquiry, reach out via call on <span style="font-weight: bold; color: #333;">+92
                                336 1312345</span>
                        </td>
                    </tr>
